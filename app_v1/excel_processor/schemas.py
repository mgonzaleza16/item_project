...
itemizado_schema = SheetSchema(
    ...
    columns=[
        ...
        ColumnSchema(old_name="Cantidad", new_name="qty_item", dtype=float),
        ColumnSchema(old_name="Unidad", new_name="unit_item", dtype=object,trim_spaces=True),
        ColumnSchema(old_name="Cantidad HH", new_name="laborunits_item", dtype=float),
...
activity_schema = SheetSchema(
    ...
    columns=[
        ...
        ColumnSchema(old_name="Cantidad", new_name="qty_activity", dtype=float, disallow_zero=True),
        ColumnSchema(old_name="HH Actividad", new_name="activity_laborunits", dtype=float, disallow_zero=True)
    ]
)
